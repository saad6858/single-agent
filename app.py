...
# ============================================================
# HIDE STREAMLIT CLOUD CHROME — SURGICAL CSS
# ============================================================
_HIDE_STREAMLIT_CHROME = """
<style>
    /* Hide Fork, GitHub, Deploy, Share links ONLY */
    ...
    /* Hide Streamlit footer and decorations */
    ...
    /* Hide Streamlit logo images */
    img[alt*="Streamlit"] {display: none !important;}
    img[alt*="streamlit"] {display: none !important;}
    img[src*="streamlit"] {display: none !important;}
    a[href*="streamlit.io"] {display: none !important;}
    
    /* Hide header action elements that are NOT the sidebar toggle */
    [data-testid="stHeaderActionElements"] a {display: none !important;}
    [data-testid="stHeaderActionElements"] button:not([aria-label*="sidebar"]):not([aria-label*="menu"]) {display: none !important;}
    
    /* Keep sidebar toggle visible */
    [data-testid="stSidebarCollapsedControl"] {display: flex !important; visibility: visible !important;}
    button[aria-label*="sidebar"] {display: flex !important; visibility: visible !important;}
    button[aria-label*="menu"] {display: flex !important; visibility: visible !important;}
    
    /* Remove bottom padding from app */
...
.hero-box{text-align:center;padding:1.5rem 1rem 1rem 1rem;margin-bottom:1rem}
...
.section-header{color:#f1f5f9;font-size:1.3rem;font-weight:700;margin-bottom:1rem;display:flex;align-items:center;gap:0.6rem;padding-bottom:0.6rem;border-bottom:1px solid rgba(148,163,184,0.15)}

.badge{display:inline-block;padding:0.25rem 0.8rem;border-radius:999px;font-size:0.72rem;font-weight:700;letter-spacing:0.5px;text-transform:uppercase}
...
.locked-box{background:rgba(15,23,42,0.5);border:2px dashed rgba(148,163,184,0.15);border-radius:20px;padding:2.5rem 1.5rem;text-align:center;margin:1rem 0}
.locked-icon{font-size:3rem;margin-bottom:0.8rem;opacity:0.8}
.locked-title{font-size:1.2rem;font-weight:700;color:#e2e8f0;margin-bottom:0.5rem}
.locked-text{color:#94a3b8;margin-bottom:1rem;font-size:0.9rem}
.locked-item{display:flex;align-items:center;justify-content:center;gap:0.5rem;color:#cbd5e1;padding:0.3rem 0;font-size:0.9rem}
...
hr{border-color:rgba(148,163,184,0.1)!important;margin:1.5rem 0!important}
...
# ============================================================
# JS MUTATIONOBSERVER — REMOVE FORK/DEPLOY/SHARE/MANAGE APP
# ============================================================
...
(function(){
    function nuke(){
        ...
        document.querySelectorAll('a,button,div,span').forEach(function(el){
            ...
            if(t === 'fork' || t === 'deploy' || t === 'share' || t === 'manage app' || t.includes('manage app')){
                el.remove();
            }
        });
    }
